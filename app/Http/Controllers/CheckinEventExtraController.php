        ...
        try{
            ...
            if($parent != null)
            {
                ...
                if($applicationEvent != null)
                {
                    ...
                    ->select('checkins.id','applications.childfirstname', 'applications.childlastname', 'applications.parentfirstname', 'applications.parentlastname',
                     'applications.parentmobile', 'checkins.child_present', 'applications.childphotopath')
