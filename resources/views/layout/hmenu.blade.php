    ...
    <div class="menu">
        <ul class="pullDown">
            ...
            <li><a href="javascript:void(0)">Admin</a>
                <ul class="pullDown">
                    <li><a href="{{secure_url('controlPanel')}}">Control Panel</a></li>
                    <li><a href="{{secure_url('contacts')}}">Contacts</a></li>
                </ul>
            </li>
            ...
            <li><a href="{{secure_url('coordinators')}}">Coordinators</a>
                <ul class="pullDown">
                    <li><a href="{{secure_url('rallyecoordinators')}}">Rallye coordinators</a></li>
                </ul>
            </li>
            <li><a href="javascript:void(0)">Settings</a>
                <ul class="pullDown">
                    ...
                    <li><a href="{{secure_url('keyvalues')}}">Key/Value</a></li>
                    <li><a href="{{secure_url('membershipprices')}}">Membership Prices</a></li>
                </ul>
            </li>
...
<!--                    <li><a href="{{secure_url('checkin')}}">Invitations</a></li> -->
            ...
            @guest
            <li><a href="{{secure_url('apply/apply')}}">Apply</a>
            <li><a href="{{secure_url('paymentsearch')}}">Payment</a>
