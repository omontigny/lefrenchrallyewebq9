...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <a href={{secure_url("/groups/create")}}><button type="button" class="btn btn-primary btn-md float-right"><span class="glyphicon glyphicon-plus"></span> Add new</button></a>
                        ...
                        <!--<table class="table table-bordered table-striped table-hover dataTable js-exportable">-->
                          ...
                          <tr>
                                  ...
                                  @endif
                                    ...
                                    <td>
                                        <a href="/groups/{{$group->id}}"><button type="button" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-edit"></span></button></a>
                                        <button type="button" class="btn btn-danger btn-sm  " data-toggle="modal" data-target="#deleteGroupModal_{{$group->id}}"><span class="glyphicon glyphicon-remove"></span></button>
                                    </td>
                                </tr>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content bg-danger">
                        ...
                        <div class="modal-body col-white">
                          {{ Form::open(['method' => 'GET', 'url' => route('groups.destroy', $group->id)]) }}
                          @csrf
                          {{ method_field('DELETE') }}
  ...
  @else
        <p> No groups found </p>
        <a href={{secure_url("/groups/create")}}><button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-plus"></span> Add new</button></a>
    @endif
    <br />
@stop
@section('page-script')
