         ...
         <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                   {{ Form::open(['action' => 'MailsController@sendMailToAllRallyeMembers', 'method' => 'POST']) }}
                   @csrf
                   ...
                   <div class="form-group row">
                     ...
                     <div class="col-sm-10">
                       <input type="text" class="form-control" disabled name="from" id="from" value="{{$rallye_title}} <{{$rallye_email}}>" required>
                     </div>
                   </div>
                   <div class="form-group row">
                     <div class="col-sm-2">
                     ...
                     <div class="col-sm-10">
                       <input type="text" class="form-control" disabled name="to" id="to"  value="{{$rallye_title}} <{{$rallye_email}}>" required>
                     </div>
                   </div>
                   <div class="form-group row">
                     <div class="col-sm-2">
                     ...
                     <div class="col-sm-10">
                       <input type="text" rows="3" class="form-control" name="bcclist" id="bcclist" value="{{$bcclist}}" required>
                     </div>
                   </div>
                   <div class="form-group row">
                     <div class="col-sm-2">
                     ...
                     <div class="col-sm-10">
                       <input type="text" class="form-control" name="subject" id="subject" value="[{{env('APP_NAME')}}] - [{{$rallye_title}}]: " required>
                     </div>
                   </div>
                 ...
                 <input name="applications" type="hidden" value="{{$applications}}">
                 <input name="rallyeEmail" type="hidden" value="{{$rallye_email}}">
