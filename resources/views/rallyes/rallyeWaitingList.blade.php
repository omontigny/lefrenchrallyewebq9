...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
          ...
          <div class="card">
                <div class="header">
                    <h2><strong>My rallye</strong> Waiting list</h2>
                    ...
                    <!-- MAIL -->
                    <a href="waitingListEmail"><button type="button" class="btn btn-warning btn-sm float-right"><span class="glyphicon glyphicon-envelope"></span> Mail</button></a>
                    <!-- MAIL -->
                  @endif
