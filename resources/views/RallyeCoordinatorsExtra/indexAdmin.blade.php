                ...
                <div class="body">
                    ...
                    <table class="table dataTable js-exportable">
                        <!--<table class="table table-bordered table-striped table-hover dataTable js-exportable">-->
                            ...
                            <tbody>
                          @foreach ($adminRallyes as $adminRallye)
                          <tr>
                                    <td>{{$adminRallye->id}}</td>
                                    <td><strong>{{$adminRallye->rallye->title}}</strong></td>
                                    @if($adminRallye->active_rallye == '1')                                    
                                    ...
                                    @endif  
                                    <td> 
                                        <a href="/rallyeCoordinatorsExtra/{{$adminRallye->id}}/AdminActiveRallyeById"><button type="button" class="btn 
                                          @if($adminRallye->active_rallye == '1')
                                          btn-success  
                                        @else
                                        btn-danger                                    
