...
@section('page-style')
<link rel="stylesheet" href="{{secure_asset('assets/plugins/jquery-steps/jquery.steps.css')}}">
@stop
@section('content')
...
<script src="{{secure_asset('assets/plugins/jquery-steps/jquery.steps.js')}}"></script>
<script src="{{secure_asset('assets/js/pages/forms/form-wizard.js')}}"></script>
@stop