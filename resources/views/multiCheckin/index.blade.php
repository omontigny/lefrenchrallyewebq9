...
@stop
@section('content')
<h3><span class="glyphicon glyphicon-envelope"></span> Multi - Check in</h3>
<hr>
...
<div class="row clearfix">
  <div class="col-lg-12">
    <div class="card">
      <div class="header">
        <h2><strong>Multi Check IN</strong> List</h2>
      </div>
      <div class="body">
          ...
          <table class="table dataTable js-exportable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="/multicheckin/{{$invitation->id}}"><button type="button" class="btn btn-primary btn-sm"><span class="glyphicon  glyphicon-info-sign"></span></button></a>
                </td>
              </tr>
              @endif
...
@else
<p>E186: You do not have any invitation, no check in to manage.</p>
@endif
